...
`canfuel/docs/firmware/install.md` step 5 says to measure every part *before* it goes in,
...
w("")
w("`canfuel/docs/firmware/install.md` step 5 has you measure every part **before** it")
