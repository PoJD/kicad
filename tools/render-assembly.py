...
and canfuel/docs/firmware/install.md step 5 says so at length. It is repeated in the
...
text(MARGIN, FY,
     ...
     "is the anode, and why the sockets must be marked before soldering: "
     "canfuel/docs/firmware/install.md step 5.", 12.5, DIM)
text(MARGIN, FY + 19,
